...
myKeys =
  ...
  , ("M-]"  , spawn "brave")                      -- Brave
  , ("M-S-k", spawn "setxkbmap -layout br")       -- ABNT-2
  , ("M-k"  , spawn "setxkbmap -layout br -variant nodeadkeys") -- My standard
...
myStartupHook = do
  ...
  spawnOnce "feh --bg-fill --no-fehbg ~/Pictures/cloudswallpaper.jpg"
